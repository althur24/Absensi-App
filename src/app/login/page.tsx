...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-teal-600 via-teal-500 to-emerald-500 flex items-center justify-center p-4">
            {/* Background Pattern */}
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-white mb-2">Absensi</h1>
